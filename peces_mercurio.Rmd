...
mvn_kt_y_se1 <- mvn(data.frame(M$X4, M$X10),
                    ...
                    covariance = FALSE,
                    showOutliers = FALSE)
mvn_kt_y_se1$multivariateNormality
```
...
De la figura \ref{fig:contorno} se encuentra por la el ángulo de la forma, puede ser que 
```{r contorno, echo=FALSE, warning=FALSE, fig.cap="\\label{fig:contorno}Datos atípicos", fig.align = 'center', out.height="30%"}
...
```{r outliers, echo=FALSE, warning=FALSE, fig.cap="\\label{fig:outliers}Datos atípicos", fig.align = 'center', out.height="30%"}
...
Se observa en la \ref{fig:outliers} que el QQ-plot no tiene una pendiente de 1, por lo que se asume que, como fue visto en la prueba de Mardia, los datos padecen de curtosis.
...
```{r var_dot, echo=FALSE, warning=FALSE, fig.cap="\\label{fig:pca}Aplicación de PCA a variables X3 a X11.", fig.align = 'center', out.height="30%"}
datos <- M_q
